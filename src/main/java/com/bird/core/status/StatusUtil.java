...
public class StatusUtil {
    ...
    /**
     * Returns true if the StatusManager associated with the context passed as parameter has one or more StatusListener
     * instances registered. Returns false otherwise.
     *
     * @param context
