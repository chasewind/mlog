...
public class CoreConstants {
    ...
    /**
     * Customized pattern conversion rules are stored under this key in the {@link Context} object store.
     */
    ...
    /**
     * Key used to locate a collision map for FileAppender instances in context's object map. The collision map consists
     * of enties of the type (appender name, File option)
     */
    public static final String     FA_FILENAME_COLLISION_MAP            = "RFA_FILENAME_COLLISION_MAP";

    /**
     * Key used to locate a collision map for RollingFileAppender instances in context's object map. The collision map
     * consists of entities of the type (appender name, FileNamePattern option)
     */
