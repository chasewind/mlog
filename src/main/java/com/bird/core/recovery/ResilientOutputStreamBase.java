...
import com.bird.core.status.ErrorStatus;
import com.bird.core.status.InfoStatus;
import com.bird.core.status.Status;
...
abstract public class ResilientOutputStreamBase extends OutputStream {
    ...
    void attemptRecovery() {
        ...
        addStatusIfCountNotOverLimit(new InfoStatus("Attempting to recover from IO failure on " + getDescription(),
                                                    this));
