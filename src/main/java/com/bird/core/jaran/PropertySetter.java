...
public class PropertySetter extends ContextAwareBase {
     ...
     * <p>
     * If the setter expects a String no conversion is necessary. If it expects an int, then an attempt is made to
    ...
    public void setProperty(String name, String value) {
        ...
        if (setter == null) {
            addError("No setter for property [" + name + "] in " + objClass.getName() + ".");
        } else {
            try {
