...
import com.bird.core.jaran.NoAutoStartUtil;
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext ic) {
        ...
        switch (aggregationType) {
            ...
            case AS_COMPLEX_PROPERTY:
                IADataForComplexProperty ad = new IADataForComplexProperty(parentBean, aggregationType,
    ...
    public void begin(InterpretationContext ec, String localName, Attributes attributes) {
        ...
        try {
            ...
            if (!OptionHelper.isEmpty(className)) {
                ...
                componentClass = parentBean.getClassNameViaImplicitRules(actionData.getComplexPropertyName(),
                                                                         actionData.getAggregationType(),
