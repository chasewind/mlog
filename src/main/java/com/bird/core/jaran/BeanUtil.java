...
public class BeanUtil {
     ...
     * @return The property name of the associated property if the given method matches a standard java beans getter or
     * setter.
     */
     ...
     * @return null if the given String is null. Emtpy string if the given string is empty. The given string if the
     * first two consecutive letters are in upper case. The given string with the first letter in lower case otherwise,
     * which might be the given string.
     */
