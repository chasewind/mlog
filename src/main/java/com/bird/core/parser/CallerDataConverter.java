...
import com.bird.core.EvaluationException;
import com.bird.core.EventEvaluator;
...
public class CallerDataConverter extends ClassicConverter {
    ...
    public void start() {
        ...
        try {
            ...
            System.err.println("Failed to parse depth option [" + depthStr + "]");
        }
        ...
        if (optionList != null && optionList.size() > 1) {
            ...
            for (int i = 1; i < optionListSize; i++) {
                ...
                if (context != null) {
                    Map<String, EventEvaluator<?>> evaluatorMap = (Map<String, EventEvaluator<?>>) context.getObject(EVALUATOR_MAP);
            ...
            for (int i = 0; i < evaluatorList.size(); i++) {
                ...
                try {
                    ...
                    if (errorCount < MAX_ERROR_COUNT) {
                        System.err.println("Exception thrown for evaluator named [" + ee.getName() + "]");
