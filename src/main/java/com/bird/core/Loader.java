...
public class Loader {
     ...
     * wrong the method returns <code>null<code>.
     */
    ...
    public static ClassLoader getClassLoaderAsPrivileged(final Class<?> clazz) {
        if (!HAS_GET_CLASS_LOADER_PERMISSION) return null;
    ...
    /**
     * If running under JDK 1.2 load the specified class using the <code>Thread</code> <code>contextClassLoader</code>
