...
import com.bird.core.parser.DateTokenConverter;
import com.bird.core.parser.IntegerTokenConverter;
import com.bird.core.parser.LiteralConverter;
import com.bird.core.parser.MonoTypedConverter;
...
public class FileNamePattern extends ContextAwareBase {
    ...
    /**
     * Given date, convert this instance to a regular expression. Used to compute sub-regex when the pattern has both %d
     * and %i, and the date is known.
     */
