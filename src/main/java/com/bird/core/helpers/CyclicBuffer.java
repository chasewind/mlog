...
public class CyclicBuffer<E> {
    ...
    /**
     * Instantiate a new CyclicBuffer of at most <code>maxSize</code> events. The <code>maxSize</code> argument must a
     * positive integer.
     * 
    ...
    /**
     * Get the <i>i</i>th oldest event currently in the buffer. If <em>i</em> is outside the range 0 to the number of
    ...
    /**
     * Get the number of elements in the buffer. This number is guaranteed to be in the range 0 to <code>maxSize</code>
     * (inclusive).
     */
    public int length() {
        return numElems;
    ...
    public void resize(int newSize) {
        ...
        if (newSize == numElems) return; // nothing to do
